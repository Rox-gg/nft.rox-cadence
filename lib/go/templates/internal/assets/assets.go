...
// ../../../templates/transactions/adminLockBox.cdc (449B)
...
var _transactionsAdminlockboxCdc = ""

func transactionsAdminlockboxCdcBytes() ([]byte, error) {
	return bindataRead(
		_transactionsAdminlockboxCdc,
		"transactions/adminLockBox.cdc",
	)
}

func transactionsAdminlockboxCdc() (*asset, error) {
	bytes, err := transactionsAdminlockboxCdcBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "transactions/adminLockBox.cdc", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info, digest: [32]uint8{0x5d, 0x3f, 0xc0, 0xc8, 0x7c, 0x8a, 0x72, 0xdc, 0x46, 0xf0, 0xc6, 0x6d, 0x6b, 0xcf, 0x96, 0xdb, 0x49, 0x2b, 0x5d, 0xd9, 0x58, 0xa9, 0xc, 0x3e, 0x5e, 0xc6, 0x4e, 0x69, 0x7f, 0xb6, 0x3b, 0x32}}
	return a, nil
}
...
var _bindata = map[string]func() (*asset, error){
	...
	"transactions/adminLockBox.cdc":      transactionsAdminlockboxCdc,
...
var _bintree = &bintree{nil, map[string]*bintree{
	...
	"transactions": {nil, map[string]*bintree{
		...
		"adminLockBox.cdc": {transactionsAdminlockboxCdc, map[string]*bintree{}},
